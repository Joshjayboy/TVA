...
//import { getMovieByIdAction } from "./MoviesActions";
...
// remove cast
export const removeCastAction = (cast) => async (dispatch, getState) => {
  dispatch({ type: moviesConstants.DELETE_CAST, payload: cast });
  localStorage.setItem("casts", JSON.stringify(getState().casts.casts));
};
